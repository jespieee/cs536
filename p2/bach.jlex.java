...
"9:9,5,4,9:2,10,9:18,5,9,8,9:13,1:10,9:3,6,9:3,2:26,9,7,9:2,3,9,2:13,11,2:4," +
"11:2,2:6,9:5,0:2")[0];

	private int yy_rmap[] = unpackFromString(1,12,
"0,1,2,3,1:2,4,1,5:3,6")[0];

	private int yy_nxt[][] = unpackFromString(7,12,
"1,2,3,4,5,6,7,4,10,4,-1,3,-1:13,2,-1:11,3:3,-1:7,3,-1:5,6,-1:7,9:3,-1,9:2,1" +
"1,8,9:3,-1:7,9,-1:3,9");
...
return new Symbol(sym.EOF);
    ...
    Symbol S = new Symbol(sym.STRINGLIT, new StrLitTokenVal(yyline+1, CharNum.num, yytext().substring(1, yytext().length() - 1)));
    CharNum.num += yytext().length();
    return S;
}
					case -9:
